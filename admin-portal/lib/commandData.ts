...
export function getRawCommandsList(): Omit<CommandDefinition, 'syntax'>[] {
  return [
    // ⚙️ SYSTEM
    { name: 'pair', desc: 'Request authentic 8-digit WhatsApp pairing code for device linking', category: 'system', permission: 'Public', aliases: ['pairing', 'paircode', 'link'], example: 'pair 2348143186133' },
