...
module.exports = {
  ...
  category: 'ai',
  description: 'Ask AI a question',
  usage: '.ask explain quantum computing simply',
  ...
  async execute(ctx) {
    ...
    const name = 'ask';
    const desc = 'Ask AI a question';
    const syntax = '.ask explain quantum computing simply';
    const example = '.ask explain quantum computing simply';
    const nameUpper = 'ASK';
    ...
    if (apiKey) {
      try {
        ...
        const systemInstruction = 'You are Kuzmix AI, an expert assistant developed by ' + config.developerName + '. Task: Ask AI a question. Format output cleanly for WhatsApp.';
