  ...
  async execute(ctx) {
    ...
    if (apiKey) {
      try {
        ...
        const systemInstruction = 'You are Kuzmix AI, an expert assistant developed by ' + config.developerName + '. Task: Explain a topic simply. Format output cleanly for WhatsApp.';
